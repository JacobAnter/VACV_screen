...
# data set files to the directory of the fine-tuned SENSE-PPI model on
# Hemera
...
do
    ...
    do
        ...
        anter87@hemera5:~/PPI_prediction/SENSE-PPI/10-fold_cross-val_on_VACV_WR_pos_and_neg_data_set_fine-tuned/k-fold_split_${i}
    done
done
