...
do
    ...
    sshpass -p "${password}" scp anter87@hemera5:~/PPI_prediction/xCAPT5/10-fold_cross-validation/without_training/with_XGBoost/xCAPT5_interaction_probs_VACV_WR_10-fold_cross-val_test_set_${i}_with_XGBoost.tsv \
    Results_with_XGBoost
done
