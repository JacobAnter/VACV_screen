...
# data set files to the directory for xCAPT5 with XGBoost on Hemera
...
do
    ...
    anter87@hemera5:~/PPI_prediction/xCAPT5/10-fold_cross-validation/without_training/with_XGBoost
done
