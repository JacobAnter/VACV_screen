...
pair_path = (
   "PPI_pairs_between_Qiagen_subset_and_VACV_WR_proteome_chunk_0_size_"
   "500,000.tsv"
)
seq_path = (
   "human_prots_Qiagen_subset_and_VACV_WR_prots_seqs_chunk_0_size_"
   "500,000.fasta"
)
...
results_df = pd.DataFrame(
   data={
      ...
      "interaction_probability": y_pred
   }
)

results_df.to_csv(
   "xCAPT5_interaction_probs_Qiagen_subset_chunk_0_size_500,000_without_XGBoost.tsv",
   sep="\t",
   index=False
)