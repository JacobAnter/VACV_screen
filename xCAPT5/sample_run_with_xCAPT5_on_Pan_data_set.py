...
N.B.: This Python script is able to reproduce the results reported in
the Jupyter notebook `CAPST5-X_inference.ipynb`. Minor differences in
the concrete values of the respective metrics are attributable to
machine precision.
"""
import os
import time
