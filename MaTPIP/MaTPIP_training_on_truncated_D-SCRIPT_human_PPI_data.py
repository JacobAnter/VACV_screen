"""
The purpose of this Python script is to train MaTPIP from scratch on a
truncated version of the human PPI data set employed in the D-SCRIPT
publication ("D-SCRIPT translates genome to phenome with sequence-based,
structure-aware, genome-scale predictions of protein-protein
interactions"). This is necessary as the MaTPIP authors do not provide
any pre-trained weights. The human PPI data set from the D-SCRIPT
publication is used for training since the MaTPIP authors use this very
data set for training in the context of cross-species PPIs.
"""
...
path_to_human_PPI_data_set_tsv = (
    "/home/anter87/PPI_prediction/MaTPIP/mat_p2ip_prj/dataset/"
    "human_PPI_data_set_D-SCRIPT_truncated/human_train_truncated.tsv"
)
...
path_to_human_PPI_data_set_fasta = (
    "/home/anter87/PPI_prediction/MaTPIP/mat_p2ip_prj/dataset/"
    "human_PPI_data_set_D-SCRIPT_truncated/human_truncated.fasta"
)

# Perform feature extraction
# Mind the trailing slash in the path definition below, it must be
# present!
path_to_data_set = "/home/anter87/PPI_prediction/MaTPIP/mat_p2ip_prj/dataset/"\
        "human_PPI_data_set_D-SCRIPT_truncated/"
feature_path = "/home/anter87/PPI_prediction/MaTPIP/mat_p2ip_prj/dataset/"\
...
model.saveModelToFile(
    path_to_data_set
    +
    "MaTPIP_model_trained_on_truncated_human_PPI_data_set.out"
)