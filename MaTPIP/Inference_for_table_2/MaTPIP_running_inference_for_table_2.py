"""
The purpose of this Jupyter notebook is to run inference of MaTPIP
trained on the human D-SCRIPT data set on the data set for table 2
(each human protein occurring in the HVIDB data set is paired with the
entire VACV WR proteome).
"""
...
output_df.to_csv(
    "predicted_probs_pos_label_for_table_2_data_set.tsv",
    sep="\t",
    header=False,
    index=False
)
