"""
The purpose of this Python script is to check whether loading a trained
model from a file works.
"""
...
path_to_trained_model = (
    ...
    "human_PPI_data_set_D-SCRIPT_truncated/MaTPIP_model_trained_on_"
    "truncated_human_PPI_data_set.out"
)
