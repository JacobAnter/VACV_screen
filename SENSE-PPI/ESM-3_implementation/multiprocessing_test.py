"""
The purpose of this Python script is to generate a draft of
multiprocessing for the embedding of protein sequences via ESM-3.
"""
...
# from the FASTA file
path_to_fasta = (
    "/Users/jacobanter/Documents/Code/VACV_screen/SENSE-PPI/ESM-3_"
    "implementation/sample_fasta_file.fasta"
)
sample_fasta = fasta.FastaFile.read(path_to_fasta)
id_seq_pairs = list(sample_fasta.items())
...
def embed_sequence(id_seq_pair):
    ...
    with torch.no_grad():
        ...
        torch.save(
            result,
            "/Users/jacobanter/Documents/Code/VACV_screen/SENSE-PPI/"
            f"ESM-3_implementation/{uniprot_ac}.pt"
        )
